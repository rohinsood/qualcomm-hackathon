...
// stops (app or bridge died), stop every output rather than run away. The
// stop must be an explicit write: the Motors module latches the last speed
// it was sent and keeps driving it on its own until told otherwise.
