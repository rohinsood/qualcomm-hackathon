 ...
 * companion SLM. Used by both the step-0 bench harness and the phase-1
 * conversation wrapper so the two can never disagree about init state.
 */
object GenieRuntime {

    private const val TAG = "GenieRuntime"

    /** The companion SLM — step-0 winner on the Hexagon NPU (12 tok/s). */
