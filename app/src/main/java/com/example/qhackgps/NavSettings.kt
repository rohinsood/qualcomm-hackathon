...
/**
 * The two knobs the HUD exposes. Persisted because both are set once and then
 * relied on: a heading trim found by walking a straight line shouldn't have to be
 * re-found every time the app restarts mid-demo, and neither should the choice of
 * routing mode.
 */
object NavSettings {
